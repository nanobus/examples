$(function () {
  ...
  function get_all_jots_fake() {
    response = {
      before: null,
      items: [
        {
          handle: "foo",
          id: "0aa66e0f-36d3-4329-9cf0-83ee2e85240c",
          likes: 1,
          message: "My JOT!",
          time: "2022-10-31T17:13:43.398031-04:00",
          userId: "ce92e651-4e7e-4a0c-a4e9-4796188cb6d6",
        },
        {
          handle: "foo 1",
          id: "0aa66e0f-36d3-4329-9cf0-83ee2e85240c",
    ...
    var jotHTML = "";
    $.each(response.items, function (index, jot) {
      let jotID = jot.id;
